...
import (
	...
	shenzhudevv1alpha1 "github.com/shenzhu/kluster/pkg/apis/shenzhu.dev/v1alpha1"
	...
	v1alpha1 "github.com/shenzhu/kluster/pkg/client/listers/shenzhu.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ShenzhuV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ShenzhuV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&shenzhudevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&shenzhudevv1alpha1.Kluster{}, f.defaultInformer)
}
