...
import (
	...
	v1alpha1 "github.com/shenzhu/kluster/pkg/client/informers/internalversion/v1alpha1"
...
type SharedInformerFactory interface {
	...
	Shenzhu() v1alpha1.Interface
}

func (f *sharedInformerFactory) Shenzhu() v1alpha1.Interface {
