...
import (
	...
	internalversion "github.com/shenzhu/kluster/pkg/client/listers/v1alpha1/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Shenzhu().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Shenzhu().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&v1alpha1.Kluster{},
		resyncPeriod,
